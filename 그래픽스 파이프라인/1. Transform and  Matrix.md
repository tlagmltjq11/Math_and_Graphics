...
Px = cos(a+b) = cosacosb - sinasinb<br>
Py = sin(a+b) = sinacosb + cosasinb<br>
<br>

여기서 Q의 성분은 Qx = cosb, Qy = sinb이기 때문에 위 성분식에 대입시켜줄 수 있게된다.<br>
Px = cosaQx - sinaQy + 0<br>
Py = sinaQx + cosaQy + 0<br>
